...
def get_vlnbert_models(args, config=None):
    ...
    if args.vlnbert == 'oscar':
        ...
        model_class = VLNBert
        #model_name_or_path = "/home/hlr/shared/data/joslin/pretrain_model/action_models3/checkpoint-91469/pytorch_model.bin"
        ...
        model_name_or_path = "/home/hlr/shared/data/joslin/pretrain_model/action_models_check/checkpoint-21780/pytorch_model.bin"
        vis_config = config_class.from_pretrained('bert-base-uncased')
        vis_config.img_feature_dim = 2176
