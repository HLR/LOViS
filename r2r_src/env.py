...
class EnvBatch():
    ...
    def __init__(self, feature_store=None, batch_size=100, obj_store=None):
        """
...
class R2RBatch():
    ...
    def __init__(self, feature_store, batch_size=100, seed=10, splits=['train'], tokenizer=None,
                 name=None, obj_store=None): #YZ
        self.env = EnvBatch(feature_store=feature_store, batch_size=batch_size, obj_store=obj_store)
        if feature_store:
